...
[Fontes de dados](#fontes-de-dados-suportadas) · [Instalação](#instalação) · [Uso](#uso) · [Demo](#demo) · [Instalação detalhada](INSTALL.md) · [**中文**](00~认知/Awesome-Agent-Skills/通用%20Skills/colleague-skill/README.md) · [**English**](README_EN.md)
