...
[データソース](#対応データソース) · [インストール](#インストール) · [使い方](#使い方) · [デモ](#デモ) · [詳細インストール](INSTALL.md) · [**中文**](00~认知/Awesome-Agent-Skills/通用%20Skills/colleague-skill/README.md) · [**English**](README_EN.md)
