...
[Источники данных](#поддерживаемые-источники-данных) · [Установка](#установка) · [Использование](#использование) · [Демо](#демо) · [Подробная установка](INSTALL.md) · [**中文**](00~认知/Awesome-Agent-Skills/通用%20Skills/colleague-skill/README.md) · [**English**](README_EN.md)
